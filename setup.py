...
c_extensions = {
    'word2vecl.word2vecl_inner': 'word2vecl/word2vecl_inner.c',
}
...
class CleanExt(distutils.cmd.Command):
    description = 'Remove C sources, C++ sources and binaries for word2vecl extensions'
    user_options = []
